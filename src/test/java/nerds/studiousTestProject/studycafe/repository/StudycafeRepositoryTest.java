...
//    @BeforeEach
//    public void setUp(){
//        this.cafe1 = studycafeRepository.save(FIRST_STUDYCAFE.기본_정보_생성(1L));
//        this.cafe2 = studycafeRepository.save(SECOND_STUDYCAFE.기본_정보_생성(2L));
//        this.cafe3 = studycafeRepository.save(THIRD_STUDYCAFE.기본_정보_생성(3L));
//        this.cafe4 = studycafeRepository.save(FOURTH_STUDYCAFE.기본_정보_생성(4L));
//        this.cafe5 = studycafeRepository.save(FIFTH_STUDYCAFE.기본_정보_생성(5L));
//        this.cafe6 = studycafeRepository.save(SIXTH_STUDYCAFE.기본_정보_생성(6L));
//        this.cafe7 = studycafeRepository.save(SEVENTH_STUDYCAFE.기본_정보_생성(7L));
//        this.cafe8 = studycafeRepository.save(EIGHTH_STUDYCAFE.기본_정보_생성(8L));
//        this.cafe9 = studycafeRepository.save(NINETH_STUDYCAFE.기본_정보_생성(9L));
//        this.cafe10 = studycafeRepository.save(TENTH_STUDYCAFE.기본_정보_생성(10L));
//        this.cafe11 = studycafeRepository.save(ELEVENTH_STUDYCAFE.기본_정보_생성(11L));
//    }
//
//    @Test
